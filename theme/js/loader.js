...
mailru.loader = {
	...
	_modulePath: 'https://web.archive.org/web/20111123115825/http://img1.imgsmail.ru/r/js/connect/',
	_loaded: {},
	_readyCallbacks: {},
				...
				if(module=='api') {
					...
					(function(obj, name, cb){
						...
						if(!mailru.loader._loaded[module] && (+new Date() - ts) > 15000){
							(new Image()).src='https://web.archive.org/web/20111123115825/http://goshka.mail.ru/gstat?api.require=1&rnd='+ Math.random();
						}
					})
				}
...
mailru.init = function(onready, private_key, DOMFlashId){
	mailru.loader.require('api', function(){
		try{
			...
			(new Image()).src='https://web.archive.org/web/20111123115825/http://goshka.mail.ru/gstat?api.param1=1&rnd='+ Math.random();
		}
		var e;
...
(function(){
	var req = function(type, log){
        try{
            ...
            (new Image()).src = 'https://web.archive.org/web/20111123115825/http://goshka.mail.ru/gstat?ua=1&clienterror.'+ type +'=1&logme='+ log;
            (new Image()).src='https://web.archive.org/web/20111123115825/http://goshka.mail.ru/gstat?api.param4=1&rnd=' + Math.random();
        } catch(e) {}
	}
...
/*
     FILE ARCHIVED ON 11:58:25 Nov 23, 2011 AND RETRIEVED FROM THE
...
/*
playback timings (ms):
  LoadShardBlock: 345.515 (3)
  esindex: 0.015
  captures_list: 1085.857
  CDXLines.iter: 78.861 (3)
  PetaboxLoader3.datanode: 101.352 (4)
  exclusion.robots: 0.285
  exclusion.robots.policy: 0.267
  RedisCDXSource: 3.768
  PetaboxLoader3.resolve: 849.009
  load_resource: 896.268
*/