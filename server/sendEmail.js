...
exports.passwordReset = function (to, recoveryList, callback) {
  ...
  htmlRecoveryLinks += '<a href="' + SITE_URL + '' +  recoveryList[0] + '?email='+ recoveryList[1] +'"><span> Please click here to reset ' + recoveryList[1] + "' account </span></a> <br>";
    ...
    var html = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">' +
        ...
        '</head>' +
        '<body>' +
        '<h2>Pandora Password recovery</h2>' +
        '<br>' +
         htmlRecoveryLinks +
        '<br>' +
        '<br>' +
        '<span>We only send password resets to registered email accounts.</span>' +
        '</body></html>';

    var details = {
        to: to,
        from: 'p.chakra115@outlook.com',
        subject: 'Pandora - Reset Password Request',
        html: html
    };
...
exports.sendRegVCode = function (to, strVerifyCode, i18n_lang, callback) {
    var str_Pandora_verification_code = 'Pandora Verification Code';
    var str_Pandora_verification_code_is = 'Pandora Verification Code is';
    if(i18n_lang == 'ru') {
        str_Pandora_verification_code = 'Pandora 验证妈';
        str_Pandora_verification_code_is = 'Pandora 验证妈是';
    }
    ...
    var html = '<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">' +
        ...
        '<html xmlns="http://www.w3.org/1999/xhtml">' +
        '<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8" />' +
        '<title>' + str_Pandora_verification_code + '</title>' +
        '</head>' +
        '<body>' +
        '<h2>' + str_Pandora_verification_code_is + '</h2>' +
        '<br>' +
        strVerifyCode +
       '</body></html>';
    ...
    var details = {
        ...
        subject: str_Pandora_verification_code,
        html: html
    };
    send(details, callback);
};
...
exports.sendWithdrawNotifyMail = function (param, callback) {
    var sms_title = 'Pandora Withdraw Request';
